          ...
          <TwoColumnMain>
            <PostBody>
              ...
              <p>
                ...
                全力で取り組み、必ずこのアプリを開発するための知識を身につけようと思います。
              </p>
              <h3>My Dream</h3>
              <p>
                私の将来の夢は世界中を笑顔にできて、世界中の役に立つエンジニアになることです。4年生からの研究テーマもファッションを通じて、世界中の人を笑顔にするという目的があります。
                ...
                <br />
                また、ファッション以外にも防災や災害の分野にかなり関心を持っているので、自分の作成した防災アプリが世界中で使用できて、このアプリを通じて世界中の人々に災害に備える意識を高め、世界中の一人でも多くの人の命を助けられるようなアプリを開発したいと考えています。
                <br />
              </p>
              <h3>My career</h3>
              <p>
